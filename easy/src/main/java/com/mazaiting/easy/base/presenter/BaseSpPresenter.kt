...
open class BaseSpPresenter<T : IBaseView> : BasePresenter<T>() {
     ...
     */
//    @Inject @Named("SpUtil") lateinit var sp: SpUtil
    /**
     * 注入上下文
     */
    @Inject
...
//        sp.put(context, key, value)
     ...
     * @return Boolean数据
     */
    protected fun getBoolean(key: String): Boolean = true
//        sp.getBoolean(context, key)
...
//        sp.getString(context, key)
     ...
     * @return int数据
     */
    protected fun getInt(key: String): Int = 0
//        sp.getInt(context, key)
}
